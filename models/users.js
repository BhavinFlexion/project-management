...
User.init({
  ...
  type: {
    ...
    validate: {
      isValidType(value) {
        if (![TYPES_FIELD.EMPLOYEE, TYPES_FIELD.ORGANISATION].includes(value)) {
  ...
  role: {
    type: DataTypes.ENUM(ROLE_FIELD.JUNIOR, ROLE_FIELD.SENIOR, ROLE_FIELD.TEAMLEADER, ROLE_FIELD.PROJECT_MANAGER),
    validate: {
      isValidType(value) {
        if (![ROLE_FIELD.JUNIOR, ROLE_FIELD.SENIOR, ROLE_FIELD.TEAMLEADER, ROLE_FIELD.PROJECT_MANAGER].includes(value)) {
